...
import com.example.tcm.muke.adapter.MainHeaderAdAdpter;
import com.example.tcm.muke.adapter.MainMenuAdapter;
import com.example.tcm.muke.util.DataUtil;
...
public class MainFragment extends Fragment {
    ...
    protected ViewPager mVPagerHeaderAd;//广告
    //菜单图标
    protected int[] menuIons = {R.mipmap.menu_airport, R.mipmap.menu_car
            ...
            , R.mipmap.menu_ticket, R.mipmap.menu_train};//主菜单 图标
    ...
    public void onActivityCreated(@Nullable Bundle saveInstanceState) {
        ...
        //菜单
        //布局样式
        mRecycleViewMenu.setLayoutManager(new GridLayoutManager(getActivity(), 4));//网格布局 4列
